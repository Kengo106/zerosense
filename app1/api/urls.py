...
from app1.api.views import ApiRaceView, ApiUIDView, ApiNewGameView, ApiJoinGameView,  ApiVoteView, APIScoreView, APIUserNameView, APIRaceResultView, APIAccountView, APISarchGameView
urlpatterns = [
